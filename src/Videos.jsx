    ...
    <Stack direction={['column', 'row']} h={'100vh'}>
      <VStack w={'full'}>
        ...
        <VStack alignItems={'flex-start'} p={'8'} w={'full'} overflow={'auto'}>
          ...
          <Text>
            This is a Sample Video for testing and Demo. Description : Lorem,
            ipsum dolor sit amet consectetur adipisicing elit. Maxime in facilis
            dolores autem blanditiis amet at quasi quisquam pariatur fuga
            numquam sit reiciendis molestiae illo, eius quod quas. Quas,
            perferendis aut praesentium amet error laborum ab ipsum optio natus
            fuga voluptatibus repellat in. Fugit eos voluptas et obcaecati
            temporibus, laborum dolores. Quae nostrum, maxime culpa saepe nemo
            omnis sint, veniam veritatis repellat, sit beatae provident sapiente
            ad rerum reprehenderit quidem sequi modi nihil dolore harum laborum.
            Doloremque eum provident temporibus?
          </Text>
        </VStack>
      </VStack>
      <VStack
